    ...
    <main className="details-page">
      ...
      <section className="details-content">
        ...
        <section className="details-section">
          ...
          <div className="details-grid">
            ...
            <div className="details-main">
              ...
              <ul>
                <li>
                  Destination-specific safety information is
                  not currently available from verified
                  BharatVerse sources.
                </li>

                <li>
                  Verify current local conditions and
                  official guidance before travelling.
                </li>

                <li>
                  For immediate danger, contact the
            ...
            <aside className="details-info">
              ...
              <p className="details-description">
                Verified destination-level accessibility
                information is not currently available in
                the supplied BharatVerse data.
              </p>
        ...
        <section className="details-section">
          ...
          <p>
            {place.significance || unavailable}
          </p>
            ...
            {relatedPlaces.map((relatedPlace) => (
              ...
              >
                ...
                <div className="related-card-content">
                  ...
                  <p>
                    {relatedPlace.description || unavailable}
                  </p>
