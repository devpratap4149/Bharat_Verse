...
// import React, { useState } from "react";
// import { Link } from "react-router-dom";
// import PlaceDetails from "../data/places";
...
//    * DATA SOURCE
//    * -----------
//    * Solo Women now uses the complete source-backed catalogue
//    * instead of the legacy 10-place places.js dataset.
//    *
//    * Current catalogDestinations.js contains 144 records.
//    *
//    * DATA SAFETY
//    * -----------
//    * The supplied women-safety dataset does not provide verified
//    * destination-level safety indicators. Therefore this page
//    * does not infer or calculate safety scores.
//    *
//    * The existing UI is preserved. Unsupported values are shown
//    * as "Not Available".
//    */

//   const womenFriendlyPlaces = catalogDestinations;
...
//         <p>
//           BharatVerse provides destination-level safety and support
//           information when verified evidence is available. Current
//           destination-level safety data is not yet available in the
...
//                     <li>
//                       Destination-specific safety guidance is not
//                       currently available from verified supplied data.
//                     </li>

//                     <li>
//                       Verify current local conditions and facility
...
//                     <strong>
//                       {place.heritageCategory || unavailable}
//                     </strong>
...
//                     <strong>
//                       {place.tourismPopularity || unavailable}
//                     </strong>
...
//                     <strong>
//                       {place.visitorCount2019_20 !== null &&
//                       place.visitorCount2019_20 !== undefined
//                         ? Number(place.visitorCount2019_20)
...
//                     <strong>
//                       {place.dataConfidence || unavailable}
//                     </strong>
...
//                   <Link
//                     to={`/catalog/${encodeURIComponent(place.id)}`}
//                     className="explore-button"
//                   >
//                     View Data Record →
//                   </Link>
...
//           <p>
//             Destination-level women-safety data is currently not
//             available from verified sources in the BharatVerse
//             dataset. Facility availability and local conditions
//             should be independently verified before travel.
//             BharatVerse will integrate verified local and official
//             safety data when suitable evidence becomes available.
//           </p>
...
//               <p>
//                 Use the appropriate emergency service below.
//                 For immediate danger, contact emergency
//                 services first.
//               </p>
...
//               <p>
//                 Emergency numbers are provided as quick-access
//                 information. Destination-specific police,
//                 medical, transport and network information is
//                 not currently verified in the supplied
//                 BharatVerse dataset. Always follow official
//                 guidance.
//               </p>
...
export default function SafeYatra() {
  return (
    <main className="safe-yatra-page">

      {/* HEADER */}
      <section className="safe-yatra-header">
        <p>SAFE YATRA</p>
        ...
        <p className="safe-yatra-description">
          Explore destination safety and support information before
          planning your journey.
        </p>
      </section>

      {/* IMAGE GRID */}
      <section className="safe-yatra-grid">

        {places.map((place) => (
          <Link
            key={place.id}
            to={`/safe-yatra/${place.id}`}
            className="safe-yatra-card"
          >
            <img
              src={place.image}
              alt={place.name}
